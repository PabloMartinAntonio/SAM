  ...
  SELECT
    ...
    (
      ...
      WHERE t2.conversacion_pk=a.conversacion_pk
        ...
        AND t2.fase IS NOT NULL AND TRIM(t2.fase)<>'' AND t2.fase <> 'CIERRE'
...
WHERE c.ejecucion_id=%s
  AND t.fase='CIERRE'
  AND x.back_fase IS NOT NULL AND TRIM(x.back_fase)<>'' AND x.back_fase <> 'CIERRE'
"""
...
print(f"updated_cierre_backfill_when_has_next={updated}")
